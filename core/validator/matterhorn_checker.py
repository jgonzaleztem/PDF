...
class MatterhornChecker:
    ...
    def _load_checkpoint_definitions(self) -> Dict:
        ...
        definitions = {
            ...
            "28-001":{
                "title": "Tab order not set to Structure in a page with annotations",
                "description": "El orden de tabulación no está establecido como 'Structure' en una página con anotaciones",
                "section": "UA1:7.18.1-1",
                "machine_checkable": True
            },
